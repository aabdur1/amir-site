...
export function Hero() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative overflow-hidden min-h-screen flex flex-col items-center justify-center pt-16 px-6"
    >
      <CursorGradient />
      ...
      >
        ...
        {/* Tagline */}
        <p
          className="text-lg sm:text-xl md:text-2xl text-center mt-4 sm:mt-6
